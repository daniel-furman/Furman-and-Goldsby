...
pr = .85 #take the mean density for intermediate stage
p = .8966
...
r4 = np.array([1e-2])
r = np.concatenate((r,r1,r2,r3,r4)) #grain sizes 

stress_boundary = np.zeros(len(r)) #initiate stress bounndary
